...
* @returns {Uint8Array}
*/
export function lk_eval(expr, pkt, argv, loose) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        if (!isLikeNone(pkt)) {
            _assertClass(pkt, Pkt);
            ptr1 = pkt.__destroy_into_raw();
        }
        wasm.lk_eval(retptr, ptr0, len0, ptr1, isLikeNone(argv) ? 0 : addHeapObject(argv), isLikeNone(loose) ? 0xFFFFFF : loose ? 1 : 0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {string}
*/
export function lk_eval2str(expr, pkt, argv, loose) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.lk_eval2str(retptr, ptr0, len0, ptr1, isLikeNone(argv) ? 0 : addHeapObject(argv), isLikeNone(loose) ? 0xFFFFFF : loose ? 1 : 0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        var r3 = getInt32Memory0()[retptr / 4 + 3];
...
* @returns {string}
*/
export function lk_encode(bytes, options) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
export class Links {
    ...
    */
    as_iter() {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.links_as_iter(ptr);
...
export class Pkt {
    ...
    */
    get_data_str() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.pkt_get_data_str(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_group_1c57e8e0b11c0284 = function(arg0) {
        const ret = getObject(arg0).group;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_domain_fa58524422295be6 = function(arg0) {
        const ret = getObject(arg0).domain;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_space_a1abd9299c81ebbb = function(arg0) {
        const ret = getObject(arg0).space;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_links_b7f21aed1f666023 = function(arg0) {
        const ret = getObject(arg0).links;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_create_4d000e09f90f9aef = function(arg0) {
    ...
    imports.wbg.__wbg_now_ca42afed78751be0 = typeof Date.now == 'function' ? Date.now : notDefined('Date.now');
