...
export function __wbg_consts_free(a: number): void;
export function consts_PUBLIC(a: number): void;
export function consts_PRIVATE(a: number): void;
...
export function pkt_get_data_str(a: number, b: number): void;
...
export function pkt_spacename(a: number, b: number): void;
export function pkt_rooted_spacename(a: number, b: number): void;
export function pkt_recv(a: number, b: number): void;
export function pkt_comp0(a: number, b: number): void;
export function pkt_comp1(a: number, b: number): void;
export function pkt_comp2(a: number, b: number): void;
export function pkt_comp3(a: number, b: number): void;
export function pkt_comp4(a: number, b: number): void;
export function pkt_comp5(a: number, b: number): void;
export function pkt_comp6(a: number, b: number): void;
export function pkt_comp7(a: number, b: number): void;
export function pkt_comp_list(a: number): number;
export function pkt_pubkey(a: number, b: number): void;
export function pkt_signature(a: number, b: number): void;
export function pkt_depth(a: number): number;
...
export function links_as_iter(a: number): number;
export function links_empty(): number;
...
export function lk_eval(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function lk_eval2str(a: number, b: number, c: number, d: number, e: number, f: number): void;
